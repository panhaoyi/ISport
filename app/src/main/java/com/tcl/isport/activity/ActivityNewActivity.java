...
public class ActivityNewActivity extends Activity implements View.OnClickListener, IActivityNewActivity {
    ...
    private final int TAKE_PHOTO_NORMAL = 22;
...
//            Log.e(TAG, imgPath);
            if (imgPath != null && !imgPath.isEmpty()) {
                ...
                Uri contentUri = FileProvider.getUriForFile(this,
                        "com.tcl.isport.fileprovider", imgFile);
                try {
                    cover.setImageBitmap(ImageUtil.getBitmapFormUri(this, contentUri));
                    Bitmap bm = ImageUtil.getBitmapFormUri(this, contentUri);
...
//                startActivityForResult(intent,7);
    ...
    private Uri getImgFile() {
        ...
        Uri contentUri = FileProvider.getUriForFile(ActivityNewActivity.this,
...
//                bytesCover=getBytes(getContentResolver().openInputStream(data.getData()));
        ...
        if (requestCode == TAKE_PHOTO_NORMAL && resultCode == RESULT_OK) {
