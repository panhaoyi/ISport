...
import com.tcl.isport.fragment.FriendFragment;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    private LinearLayout item_home, item_sport, item_find, item_friend, item_mine;
    private ImageView icon_home,icon_sport,icon_find, icon_friend, icon_mine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        item_friend= (LinearLayout) findViewById(R.id.item_friend);
        ...
        icon_friend= (ImageView) findViewById(R.id.icon_friend);
    ...
    public void changeIcon(int position) {
        ...
        switch (position) {
            case 0:
                ...
                icon_friend.setImageResource(R.drawable.ic_unselected_friend);
            ...
            case 3:
                ...
                icon_sport.setImageResource(R.drawable.ic_unselected_sport);
                icon_find.setImageResource(R.drawable.ic_unselected_find);
                icon_friend.setImageResource(R.drawable.ic_selected_friend);
                icon_mine.setImageResource(R.drawable.ic_unselected_mine);
                break;
            case 4:
                icon_home.setImageResource(R.drawable.ic_unselected_home);
